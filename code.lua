...
local espbox = ESPSection:CreateToggle("espbox", { Title = "Box ESP", Default = false })
local espname = ESPSection:CreateToggle("espname", { Title = "Name ESP", Default = false })
local esphealth = ESPSection:CreateToggle("esphealth", { Title = "Health ESP", Default = false })
local esptracer = ESPSection:CreateToggle("esptracer", { Title = "Tracer ESP", Default = false })
local esptracermode = ESPSection:CreateDropdown("esptracermode", { Title = "Tracer Mode", Values = { "bottom", "center", "side" }, Default = "bottom" })
local espskeleton = ESPSection:CreateToggle("espskeleton", { Title = "Skeleton ESP", Default = false })
local espskeletonmode = ESPSection:CreateDropdown("espskeletonmode", { Title = "Skeleton Mode", Values = { "minimal", "full" }, Default = "minimal" })
local espmaster = ESPSection:CreateToggle("espmaster", { Title = "ESP Master", Default = false })
